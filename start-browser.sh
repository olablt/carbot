...
# Extract the URL
DEBUG_URL=$(grep -m 1 'DevTools listening on' /home/bob/Projects/autoplius/.tmp/chromium_debug.txt | awk '{print $NF}')
echo $DEBUG_URL > /home/bob/Projects/autoplius/.tmp/chromium_debug.txt
