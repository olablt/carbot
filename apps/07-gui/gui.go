...
func (cp *AdsGUI) RegisterCommand(command string, callback func(), key key.Filter) {
...
func (cp *AdsGUI) SetCallback(command string, callback func()) {
...
func (cp *AdsGUI) InputLayout(gtx C, th *material.Theme) D {
	// layout
...
func (cp *AdsGUI) ListLayout(gtx C, th *material.Theme) D {
...
// func (cp *AdsGUI) submit(i int) {
func (cp *AdsGUI) submit(command string) {
...
func (cp *AdsGUI) HandleShortcutKeys(gtx layout.Context) {
	// tag := &cp.SearchInput
...
func (cp *AdsGUI) ProcessPointerEvents(gtx layout.Context) {
...
func (cp *AdsGUI) ProcessKeyEvents(gtx layout.Context) {
	tag := &cp.SearchInput
	event.Op(gtx.Ops, tag)
...
func (cp *AdsGUI) Update(gtx layout.Context) {
...
func (cp *AdsGUI) Layout(gtx layout.Context, th *material.Theme) D {
